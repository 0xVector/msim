...
adp.send(ReadVirtMemoryRequest, arg0=DEFAULT_CPU, arg1=RST_VEC_VIRT + 1).expect_response(StatusOk,
                                                                                         arg0=nop_word_shifted,
...
for addr in range(START, START + READ_SIZE + 1, READ_SIZE):
    ...
    adp.send(ReadPhysMemoryRequest, arg0=at_phys(addr)).expect_response(StatusOk, arg0=0x00, arg1=0x00, arg2=0x00)
    adp.send(WritePhysMemoryRequest, arg0=at_phys(addr), arg1=value).expect_response()
    adp.send(ReadVirtMemoryRequest, arg0=DEFAULT_CPU, arg1=at(addr)).expect_response(StatusOk, arg0=value, arg1=0x00,
                                                                                     arg2=0x00)

# Write another pattern, virtual then read as physical
for addr in range(START, START + READ_SIZE + 1, READ_SIZE):
    value = addr ^ 0x44332211
    adp.send(WriteVirtMemoryRequest, arg0=DEFAULT_CPU, arg1=at(addr), arg2=value).expect_response()
    adp.send(ReadPhysMemoryRequest, arg0=at_phys(addr)).expect_response(StatusOk, arg0=value, arg1=0x00, arg2=0x00)
